...
<details
    ...
    ontoggle={(e) => {
        ...
        if (link) link.classList.toggle("hidden");
        if (link) link.classList.toggle("flex");
    }}
>
    <summary
    ...
    >
        ...
        <div class="flex gap-2">
            <a
                href={b.url}
                target="_blank"
                class="hidden items-center gap-1 text-xs font-semibold not-italic text-sky-500 border border-sky-500 px-1 rounded"
            >
